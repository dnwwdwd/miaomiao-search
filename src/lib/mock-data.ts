...
export const initialEngines: SearchEngine[] = [
  { id: "bing", name: "Bing", enabled: true, isDefault: true, mode: "Auto", resultLimit: null, health: "Healthy", latency: 210, lastError: "—", lastTestAt: "2026-08-23 16:02", requiresProxy: false, requiresApiKey: false, supportsApiKey: false, apiKeyOptional: false, apiKeyConfigured: false, maxResults: 50 },
  { id: "baidu", name: "Baidu", enabled: true, isDefault: false, mode: "—", resultLimit: 20, health: "Degraded", latency: 870, lastError: "部分结果缺失", lastTestAt: "2026-08-23 15:58", requiresProxy: false, requiresApiKey: false, supportsApiKey: false, apiKeyOptional: false, apiKeyConfigured: false, maxResults: 50 },
  { id: "duckduckgo", name: "DuckDuckGo", enabled: true, isDefault: true, mode: "—", resultLimit: null, health: "Healthy", latency: 256, lastError: "—", lastTestAt: "2026-08-23 16:02", requiresProxy: true, requiresApiKey: false, supportsApiKey: false, apiKeyOptional: false, apiKeyConfigured: false, maxResults: 50 },
  { id: "sogou", name: "Sogou", enabled: true, isDefault: false, mode: "—", resultLimit: 5, health: "Rate Limited", latency: 0, lastError: "HTTP 429", lastTestAt: "2026-08-23 15:55", requiresProxy: false, requiresApiKey: false, supportsApiKey: false, apiKeyOptional: false, apiKeyConfigured: false, maxResults: 50 },
  { id: "exa", name: "Exa", enabled: true, isDefault: false, mode: "—", resultLimit: 10, health: "Blocked", latency: 0, lastError: "上游拒绝连接", lastTestAt: "2026-08-23 15:51", requiresProxy: false, requiresApiKey: true, supportsApiKey: true, apiKeyOptional: false, apiKeyConfigured: false, credentialLabel: "Exa API Key", credentialPlaceholder: "exa-...", credentialUrl: "https://dashboard.exa.ai/api-keys", maxResults: 50 },
  { id: "csdn", name: "CSDN", enabled: true, isDefault: false, mode: "—", resultLimit: 10, health: "Unknown", latency: null, lastError: "尚未测试", lastTestAt: "—", requiresProxy: false, requiresApiKey: false, supportsApiKey: false, apiKeyOptional: false, apiKeyConfigured: false, maxResults: 50 },
  { id: "juejin", name: "Juejin", enabled: false, isDefault: false, mode: "—", resultLimit: null, health: "Disabled", latency: null, lastError: "管理员已停用", lastTestAt: "2026-08-22 18:10", requiresProxy: false, requiresApiKey: false, supportsApiKey: false, apiKeyOptional: false, apiKeyConfigured: false, maxResults: 50 },
  { id: "firecrawl", name: "Firecrawl", enabled: false, isDefault: false, mode: "—", resultLimit: null, health: "Disabled", latency: null, lastError: "需要配置 API Key", lastTestAt: "—", requiresProxy: false, requiresApiKey: true, supportsApiKey: true, apiKeyOptional: false, apiKeyConfigured: false, credentialLabel: "Firecrawl API Key", credentialPlaceholder: "fc-...", credentialUrl: "https://www.firecrawl.dev/app/api-keys", maxResults: 50 },
