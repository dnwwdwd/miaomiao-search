...
export const initialEngines: SearchEngine[] = [
  { id: "bing", name: "Bing", enabled: true, isDefault: true, mode: "Auto", health: "Healthy", latency: 210, lastError: "—", lastTestAt: "2026-08-23 16:02" },
  { id: "baidu", name: "Baidu", enabled: true, isDefault: false, mode: "—", health: "Degraded", latency: 870, lastError: "部分结果缺失", lastTestAt: "2026-08-23 15:58" },
  { id: "duckduckgo", name: "DuckDuckGo", enabled: true, isDefault: true, mode: "—", health: "Healthy", latency: 256, lastError: "—", lastTestAt: "2026-08-23 16:02" },
  { id: "sogou", name: "Sogou", enabled: true, isDefault: false, mode: "—", health: "Rate Limited", latency: 0, lastError: "HTTP 429", lastTestAt: "2026-08-23 15:55" },
  { id: "exa", name: "Exa", enabled: true, isDefault: false, mode: "—", health: "Blocked", latency: 0, lastError: "上游拒绝连接", lastTestAt: "2026-08-23 15:51" },
  { id: "brave", name: "Brave", enabled: true, isDefault: false, mode: "—", health: "Unavailable", latency: null, lastError: "DNS 临时失败", lastTestAt: "2026-08-23 15:47" },
  { id: "csdn", name: "CSDN", enabled: true, isDefault: false, mode: "—", health: "Unknown", latency: null, lastError: "尚未测试", lastTestAt: "—" },
  { id: "juejin", name: "Juejin", enabled: false, isDefault: false, mode: "—", health: "Disabled", latency: null, lastError: "管理员已停用", lastTestAt: "2026-08-22 18:10" },
  { id: "startpage", name: "Startpage", enabled: true, isDefault: false, mode: "—", health: "Healthy", latency: 302, lastError: "—", lastTestAt: "2026-08-23 16:00" },
];

export const initialResults: SearchResult[] = [
  { id: "r-1", title: "Open-WebSearch：无需 API Key 的多引擎搜索服务", url: "https://github.com/open-websearch/open-websearch", description: "面向自托管场景的搜索聚合和网页正文提取工具，支持多源结果去重。", engines: ["Bing", "DuckDuckGo", "Brave"] },
  ...
  { id: "r-3", title: "自托管搜索服务的缓存与观测实践", url: "https://example.net/notes/search-cache-observability", description: "介绍搜索结果缓存、正文缓存和按引擎统计的基础实现方法。", engines: ["DuckDuckGo", "Startpage"] },
];

export const initialHistory: SearchHistory[] = [
  { id: "h-1", query: "Open-WebSearch MCP", engines: ["Bing", "DuckDuckGo"], count: 12, createdAt: "今天 15:42" },
  { id: "h-2", query: "自托管联网搜索", engines: ["Baidu", "Startpage"], count: 8, createdAt: "昨天 11:16" },
  { id: "h-3", query: "网页正文提取 SSRF", engines: ["Bing"], count: 5, createdAt: "8 月 21 日" },
];

export const initialTools: McpTool[] = [
  { id: "search", name: "search", description: "多引擎聚合搜索", parameters: "query, limit, engines, searchMode", enabled: true },
...
export const initialUsageLogs: UsageLog[] = [
  ...
  { id: "req_01HZYKX6", channel: "MCP", operation: "search", token: "ows_38Af…", engines: ["Brave", "Bing"], latency: 1050, cacheHit: false, resultCount: 8, status: "Partial", errorCode: "ENGINE_RATE_LIMIT", createdAt: "2026-08-23 15:56:20" },
  ...
  { id: "req_01HZYKX3", channel: "MCP", operation: "search", token: "ows_38Af…", engines: ["Startpage"], latency: 497, cacheHit: false, resultCount: 6, status: "Success", errorCode: "—", createdAt: "2026-08-23 15:23:18" },
...
export const initialSettings: SettingsState = { proxyEnabled: true, proxyUrl: "http://admin:••••••••@10.0.0.5:7890", searchCacheEnabled: true, contentCacheEnabled: true, searchTtl: 3600, contentTtl: 86400, cacheMaxSize: 1000, webRpm: 30, mcpRpm: 60, engineConcurrency: 3, defaultLimit: 10, historyEnabled: true, historyRetentionDays: 30, logFullQuery: false };

export const clientTemplates: Record<string, string> = {
  "WorkBuddy": `{"mcpServers":{"lazycat-search":{"url":"https://search.example.com/mcp","headers":{"Authorization":"Bearer <YOUR_ACCESS_TOKEN>"}}}}`,
  "Cherry Studio": `{"mcpServers":[{"name":"lazycat-search","type":"streamable-http","url":"https://search.example.com/mcp","headers":{"Authorization":"Bearer <YOUR_ACCESS_TOKEN>"}}]}`,
  ...
  "Codex / Cursor": `{"lazycat-search":{"command":"npx","args":["mcp-remote","https://search.example.com/mcp"],"env":{"AUTHORIZATION":"Bearer <YOUR_ACCESS_TOKEN>"}}}`,
