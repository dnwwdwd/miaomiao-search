...
|---|---|---|---|---|---|---|
| REQ-20260831-003 | 2026-08-31 | Bug / 搜索 / MCP / 凭据 / 数据隔离 | Exa MCP 使用用户数据库凭据 | 待验证 | `Requirements/REQ-20260831-003-exa-mcp-database-credential.md`、`Decisions/DEC-20260831-003-exa-database-credential.md`、`Progress/PROG-REQ-20260831-003-exa-database-credential.md` | Exa 已迁移为 Fastify 直接 Provider，Web/MCP 从当前用户加密设置读取 Key；待最终自动化与设备验证。 |
| REQ-20260831-002 | 2026-08-31 | Bug / UI/体验调整 / 搜索 / 凭据 | 门户下拉层、正文阅读器与凭据交互收口 | 待验证 | `Requirements/REQ-20260831-002-portal-dropdown-reader-credentials.md`、`Decisions/DEC-20260831-002-portal-interaction-and-bilibili-details.md`、`Progress/PROG-REQ-20260831-002-portal-interaction-and-bilibili-details.md` | 下拉浮层、B站详情、凭据申请入口/明文切换、首页最后来源提示和 Tag 修改提示已实现；待登录后浏览器回归。 |
| REQ-20260831-001 | 2026-08-31 | 功能需求 / 搜索 / MCP / UI / 安全 | 新增 Firecrawl、Tavily、GitHub 与 B站搜索源 | 待验证 | `Requirements/REQ-20260831-001-four-search-providers.md`、`Decisions/DEC-20260831-001-four-search-providers.md`、`Progress/PROG-REQ-20260831-001-four-search-providers.md` | 本地 Provider、门户、MCP、历史快照、审计和默认测试已完成；真实外部 API 与设备回归待验证。 |
